...
class PromptSettings(BaseModel):
    ...
    INIT: str = """
    Your name is Mary. You must send exactly this welcome message, without quotation marks and in English:
        '
    ...
    Your primary language is English, but you should translate the response to other languages if the user requests it.
    ...
    Answer in English, except if the user requests a different language.
